...
# Scan-type x scorer ablation: scan_type='sweep', re-scored with the student-maha readout.
# Input = log-Mel, e50 schedule. Same architecture as scan-type/sweep.py (matching scan_type
...
# Used by docs/reeval_sp_mean.py to re-score a scan-type/sweep.py training run.
