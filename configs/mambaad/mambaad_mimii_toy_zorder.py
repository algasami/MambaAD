...
# Scan ablation: 'zorder' (Z-order/Morton curve — locality-preserving like Hilbert,
# but with periodic long jumps). Baseline is mambaad_mimii_toy.py
